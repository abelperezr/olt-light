...
sidebar_position: 6
title: eCLI guide
description: Access, navigation, and basic ONT provisioning through the Light OLT eCLI.
---
...
- If you only use the eCLI, you do not need to run the `olt-proxy:0.0.1` image.
- The image already contains some of the configuration shown in this guide.
...
1. [Inspect a context configuration](#inspect-a-context-configuration).
2. [Switch OLT contexts](#switch-olt-contexts).
3. [Change the system name](#change-the-system-name).
...
Run this section in the **IHUB** context; see [Switch OLT contexts](#switch-olt-contexts).
...
:::warning Values without completion
